...
int main(){
    ...
    TrainStation* A3 = new TrainStation( "A3", 3, nullptr, nullptr, "A3" );
    ...
    TrainStation* B3 = new TrainStation( "B3", 3, nullptr, nullptr, "B3" );
    ...
    A2->getNeighbors()->addElement( A3 );
    A3->getNeighbors()->addElement( A2 );
    A3->getNeighbors()->addElement( A4 );
    A4->getNeighbors()->addElement( A3 );
    A4->getNeighbors()->addElement( A5 );
    A5->getNeighbors()->addElement( A4 );

    B1->getNeighbors()->addElement( B2 );
    B2->getNeighbors()->addElement( B1 );
    B2->getNeighbors()->addElement( B3 );
    B3->getNeighbors()->addElement( B2 );
    B3->getNeighbors()->addElement( B4 );
    B4->getNeighbors()->addElement( B3 );
    B4->getNeighbors()->addElement( B5 );
    B5->getNeighbors()->addElement( B4 );
